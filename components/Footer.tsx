...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#2D2D2D] text-white pt-16 pb-8 px-6 flex flex-col items-center text-center overflow-hidden xl:mx-8 xl:mb-8 xl:border-[#1d1d1d] xl:border-2 xl:px-28 xl:pt-12 xl:pb-12 xl:justify-between">
      ...
      <div className="flex flex-col items-center gap-8 mb-16 w-full max-w-md xl:max-w-none xl:flex-row xl:justify-between xl:items-start xl:mb-8">
        ...
        <div className="flex flex-col items-center xl:items-end gap-2">
            <div className="flex items-center gap-0">
                <a 
                    ...
                    className="rounded-lg hover:text-gray-300 transition-colors"
      ...
      <div className="w-full mt-auto xl:mt-0 xl:flex xl:justify-between xl:items-end">
        <h1 className="text-5xl md:text-6xl font-thin text-white tracking-tight xl:text-left">
            Lab Desain Budaya
        </h1>

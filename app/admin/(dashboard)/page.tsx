    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <a href="/admin/archives" className="text-blue-600 hover:underline text-sm font-medium">Go to Archives →</a>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <a href="/admin/craftsmen" className="text-blue-600 hover:underline text-sm font-medium">Go to Craftsmen →</a>
        </div>
      </div>
    </div>
  );

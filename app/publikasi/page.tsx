...
const FILTERS = ["Semua", "Artikel", "Lainnya", "Jurnal"];
...
const PublikasiPage = () => {
  ...
  const filteredData = activeFilter === "Semua" 
    ? PUBLICATION_DATA 
    : PUBLICATION_DATA.filter(item => item.type === activeFilter);
      ...
      <div className="pt-32 pb-16 px-6 xl:px-12 max-w-[1440px] mx-auto">
        ...
        <div className="text-center mb-12 xl:mb-16">
          <h1 className="text-4xl xl:text-7xl font-raleway font-normal tracking-wide leading-tight uppercase xl:normal-case">
            <span className="block xl:inline xl:mr-3">Publikasi</span>
            <br className="xl:hidden" />
            <span className="block xl:inline">Lab Desain Budaya</span>
          </h1>
        </div>
              ...
              <div className="p-4 flex flex-col justify-between h-[180px]">
                ...
                <div className="flex justify-between items-end mt-4 group-hover:text-white transition-colors duration-300">
                  <span className="font-raleway text-md font-semibold">
                    {item.year}/ <span className="text-gray-500 font-normal group-hover:text-gray-300 transition-colors duration-300 italic">{item.type}</span>
                  </span>
                  <ArrowRight 
                    size={20} 
                    strokeWidth={1} 
